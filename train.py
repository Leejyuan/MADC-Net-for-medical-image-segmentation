# -*- coding: utf-8 -*-
"""
Created on Thu Dec  5 11:26:52 2019
...
parser.add_argument('--dataset', type=str, default=r'', help='Dataset you are using.')
...
parser.add_argument('--model', type=str, default="NETWORK", help='The model you are using. See model_builder.py for supported models')
...
for epoch in range(args.epoch_start_i, args.num_epochs):
    ...
    if not os.path.isdir("%s/%04d"%("checkpoints",epoch)):
        os.makedirs("%s/%04d"%("checkpoints_",epoch))
